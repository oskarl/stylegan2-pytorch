...
# FID
bs = 32
fid = Evaluators.FID(batch_size=bs, real_mean_cov_file='/content/drive/MyDrive/GAN/files/ffhq_128_stats_ttur.pickle', resize_to=139)#'/content/drive/MyDrive/GAN/files/ffhq_128_stats_ttur.pickle', resize_to=139)#celeba_64_stats.pickle')
